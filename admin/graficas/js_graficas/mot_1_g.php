<?php 
    ...
    if ($rol == 1) {
        $result = mysql_query("SELECT mot_1 FROM datos_posgrado");
    }else{
        $result = mysql_query("SELECT mot_1 FROM datos_posgrado WHERE posgrado='$rol' ");
    }
...
<div id="mot_1" style="width: 700px; height: 450px;"></div>