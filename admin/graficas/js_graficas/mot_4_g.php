<?php 
    ...
    if ($rol == 1) {
        $result = mysql_query("SELECT mot_4 FROM datos_posgrado");
    }else{
        $result = mysql_query("SELECT mot_4 FROM datos_posgrado WHERE posgrado='$rol' ");
    }
...
<div id="mot_4" style="width: 700px; height: 450px;"></div>